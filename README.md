...
В главном меню реализован выбор из 3 типов космических кораблей, отличающихся балансом характеристик:
* **Прочность (HP)**
* **Скорость (Speed)**
...
2. **Вторичное оружие (X)**: Ограниченный боезапас, требует подбора бонусов на уровне.
...
* **Свободное патрулирование**: Случайное перемещение в заданном радиусе. При обнаружении игрока или вражеской команды в зоне видимости — переход в режим агрессии и атаки.
* **Патрулирование по маршруту**: Движение по строго заданным точкам (Waypoints). Противник атакует игрока только в том случае, если тот пересекает границы патрулируемого маршрута.

![](Assets/Screenshots/bots.png)
